...
<body onload="VistaInicio()">
	<div id="contenedor">
		...
		<div id="ventanalogin">
			...
			<div id="formlogin">
				...
				<form method="POST" name="formingreso">
					...
					<input type="text" name="txtnrcarnet" placeholder="#Carnet..." required>
		...
		<header>
			...
			<div id="titulo">
				<h1>BIBLOTECA TESH</h1>
			</div>	

			<div id="banner">
				<div><img src="img/tec.png" width="900" height="200"></div>	
			</div>
		...
		<footer>
			<p>Biblioteca  Virtual Tecnologico de Estudios Superiores de Huxquilucan 2020 © </p>
		</footer>
